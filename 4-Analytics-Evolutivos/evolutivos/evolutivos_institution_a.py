"""
Analytics · Evolutivos for Institution (Bank Alpha)

Daily, monthly and YoY analytics over financial transactions.
Includes:
- lightweight append-based persistence for evolutive tables
- helper to parse JSON-like tag columns (customer/account tags)
"""
...
# ======================================================
# TAG PARSING (CUSTOM TAGS COLUMN)
# ======================================================

def parse_tags_column(
    df: pd.DataFrame,
    col_name: str = "CUSTOMER_TAGS",
    strip_prefix: str = "bank.alpha/",
) -> pd.DataFrame:
    """
    Parse a text column containing JSON-like tags and expand it into normal columns.

    Example cell:
        {"bank.alpha/segment": "Premium", "bank.alpha/risk": "Low"}
    """
...
def load_transactions(
    ...
    schema = _get_schema(INSTITUTION_A_CONFIG, "bank_alpha_analytics")
    where_clauses = []
